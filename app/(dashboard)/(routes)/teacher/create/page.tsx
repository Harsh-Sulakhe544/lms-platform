// create a form for teacher to fill  to add the courses 
"use client";
    ...
    const onSubmit = async (values : z.infer<typeof formSchema>) => {
        ...
        try {
          ...
          toast.success("Course Created");
            ...
            // display the error ontop  of chrome
